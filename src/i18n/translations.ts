    ...
    legal: {
      ...
      privacy: {
        ...
        sections: [
          ...
          { title: "Data we process", body: "We may process information you submit through forms or email, such as your name, company, email address, project details and assessment answers. We also process basic technical data required to deliver and secure the website." },
  ...
  de: {
    ...
    legal: {
      impressum: {
        ...
        provider: ["BerryBrain AI", "Website: berrybrainai.com", "Deutschland"],
