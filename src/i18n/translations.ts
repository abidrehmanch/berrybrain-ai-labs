  ...
  en: {
    ...
    legal: {
      impressum: {
        ...
        provider: ["BerryBrain AI", "Owner: Rehman Abid", "Website: berrybrainai.com", "Germany"],
        contactTitle: "Contact",
        contact: ["Email: info@berrybrainai.com", "Web: https://berrybrainai.com"],
        responsibleTitle: "Responsible for content according to § 18 Abs. 2 MStV",
        responsible: "Rehman Abid, BerryBrain AI, Germany",
        ...
        note: "Please have this Impressum reviewed by a qualified legal professional before publication, especially if company registration, VAT ID or full postal address details apply.",
      },
    },
    lang: { en: "EN", de: "DE" },
  },
  de: {
    ...
    legal: {
      impressum: {
        ...
        provider: ["BerryBrain AI", "Inhaber: Rehman Abid", "Website: berrybrainai.com", "Deutschland"],
        contactTitle: "Kontakt",
        contact: ["E-Mail: info@berrybrainai.com", "Web: https://berrybrainai.com"],
        responsibleTitle: "Verantwortlich für den Inhalt nach § 18 Abs. 2 MStV",
        responsible: "Rehman Abid, BerryBrain AI, Deutschland",
